...
export type AllowedTextMediaType = 'text/plain' | 'text/markdown' | 'text/x-markdown';
...
export function isAllowedTextMediaType(value: string): value is AllowedTextMediaType {
 ...
 * directly and break the parent-child invariants the ingestion pipeline relies on.
 */
 ...
 */
export function parseOptionalDate(formData: FormData): string | undefined | null {
 ...
 */
export function parseOptionalString(formData: FormData, fieldName: string): string | undefined {
